...
public class SeedMappings
	...
	public void seedMappings(String Attribute, double UpperPoint, double LowerPoint)
		...
		if (MappedAttributes.contains(Attribute) || isNodeAttributeMapped(Attribute)) 
			...
			switch(CountMapping)
				...
				case 0:
					NAC.setCalculator(
								new BasicCalculator("GaggleNodeColor_"+Attribute, 
				...
				case 1:
					NAC.setCalculator(
							new BasicCalculator("GaggleNodeSize_"+Attribute,
				...
				case 2:
					NAC.setCalculator(
							new BasicCalculator("GaggleNodeShape_"+Attribute, 
				...
				case 3:
					NAC.setCalculator(
							new BasicCalculator("GaggleNodeBorder_"+Attribute,
				...
				case 4:
					NAC.setCalculator(
							new BasicCalculator("GaggleBorderColor_"+Attribute,
	...
	private ContinuousMapping getNodeShape(String Attribute, double UpperPoint, double MidPoint, double LowerPoint)
		{
	  // shapes used
	  final NodeShape CIRCLE = NodeShape.ROUND_RECT;
	  final NodeShape SQUARE = NodeShape.RECT;
	  final NodeShape TRIANGLE = NodeShape.TRIANGLE;
	  final NodeShape HEXAGON = NodeShape.HEXAGON;
	  final NodeShape TRAPEZOID = NodeShape.TRAPEZOID;

		ContinuousMapping Map = new ContinuousMapping( CIRCLE, ObjectMapping.NODE_MAPPING);
		Map.setControllingAttributeName(Attribute, Cytoscape.getCurrentNetwork(), false);
	...
	private ContinuousMapping getNodeBorderLineType(String Attribute, double UpperPoint, double MidPoint, double LowerPoint)
	  ...
	  // sizes used
        ...
        */
    final Stroke High    = LineStyle.SOLID.getStroke(7);
		final Stroke MidHigh = LineStyle.EQUAL_DASH.getStroke(5);
		final Stroke Mid     = LineStyle.SOLID.getStroke(4);
		final Stroke MidLow  = LineStyle.EQUAL_DASH.getStroke(3);
		final Stroke Low     = LineStyle.SOLID.getStroke(1);

		ContinuousMapping Map = new ContinuousMapping( Mid, ObjectMapping.NODE_MAPPING);
		Map.setControllingAttributeName(Attribute, Cytoscape.getCurrentNetwork(), false);
