...
public class HandleNetworkTask implements Task {
    ...
    public String getTitle() { return "Creating Network..."; }
    ...
    public void run() {
        ...
        while (maxCount > i) {
            ...
            Attributes.addAttributes(gaggleNetwork, NetworkObject.NODE);
            for (Interaction CurrentInteraction : gaggleNetwork.getInteractions()) {
                ...
                Edge selectEdge = (Edge) Cytoscape.getCyEdge(srcNode,
                                                             targetNode,
